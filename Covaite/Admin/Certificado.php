...
<div class="container">
	<div class="well" style="margin-top: 50px;">
		<div class="row">
			<div class="col-xs-12">
				<h2 style="text-align: center;">Descarga el certificado según su participación</h2>
			</div>
		</div>
		<br>
		<br>
		<form action="" method="POST">
			<div class="row">
				<div class="col-xs-12 col-sm-3 col-sm-offset-1">
				 	<label for="exampleSelect1" class="bmd-label-floating">¿Cómo participó?</label>
	                ...
	                <div style='display:block;left:0px;' class='Area_Oscura2'>
	                  <div class='container'>
	                    <div class='row'>
	                      <div class='col-sm-4 col-sm-offset-4'>
	                        <div class='well' style='margin-top:55%;'>
	                          <h4 align='center'>No se encontraron datos del participante en el congreso.</h4>
	                          <div class='row'>
	                            <div class='col-sm-6 col-sm-offset-3'>
	                                <a href='Certificado.php' style='width:100%' class='btn btn-info btn-raised'>Aceptar</a>
	                            </div>
                ...
                <div style='display:block;left:0px;' class='Area_Oscura2'>
                  <div class='container'>
                    <div class='row'>
                      <div class='col-sm-4 col-sm-offset-4'>
                        <div class='well' style='margin-top:55%;'>
                          <h4 align='center'>Verifique sus datos ingresados.</h4>
                          <div class='row'>
                            <div class='col-sm-6 col-sm-offset-3'>
