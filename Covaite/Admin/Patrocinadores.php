...
include("Head.php");
$Consul = $conex->query("SELECT Id_Congreso FROM patrocinadores WHERE Id_Congreso='$Id_Congreso'");
if (mysqli_num_rows($Consul)=="") {
  $Registro = $conex->query("INSERT INTO patrocinadores VALUES('$Id_Congreso','')");
}
?>
<style type="text/css">
  label{
    ...
    <div class="well">
      ...
      <div class="row">
        <div class="col-sm-offset-4 col-sm-4">
          <p style="text-align: center;">Elija una imagen donde se encuentren todos los patrocinadores del Congreso</p>
          <form action="UploadPatrocinadores.php" class="dropzone" id="myDrop1">
