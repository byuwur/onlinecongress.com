  ...
  <div class="slider">
    ...
    <div class="slide slide-1 ">
      ...
      <div class="slide__content">
        ...
        <div class="slide__text">
          ...
          <p class="slide__text-desc" style="font-size: 22px;">Todo un mundo por descubrir y compartir. ¡COVAITE te espera!  
          </p>
        </div>
      </div>
    </div>
    <div class="slide slide-2">
      ...
      <div class="slide__content">
        ...
        <div class="slide__text">
          <h2 class="slide__text-heading">Si eres docente o estudiante. </h2>
...
<div class="container">
 ...
 <div id="services" class="content-section-b">
  <div class="Alto container" style="margin-top: 50px;">
    <div class="row">
      <div class="col-sm-12">
        <hr class="section-heading-spacer" style="background:#ff5722; width:20%">
        <div class="clearfix"></div>
        <h2 class="section-heading">¿Qué significa covaite?</h2>
 ...
 <div id="services" class="content-section-b">
  <div class="Alto container-fluid" style="margin-top: 100px;">
    <div class="row">
      ...
      <div class="col-sm-6">
        <hr class="section-heading-spacer" style="background:#ff5722; width:20%">
        <h1 style="color: #81818" class="section-heading">¿Quiénes pueden participar?</h1>
        ...
        <p class="animar3" style="color:#818181;padding-left:15px; border-left: dashed 3px #ff5722; text-align:left; font-size: 24px">Docentes de Todos los niveles Educativos.</p>
        <p class="animar2" style="color:#818181;padding-left:15px; border-left: dashed 3px #ff5722; text-align:left; font-size: 24px">Estudiantes de nivel superior universitario y no universitario.</p>
        <p class="animar3" style="color:#818181;padding-left:15px; border-left: dashed 3px #ff5722; text-align:left; font-size: 24px">Investigadores en el área de Educación y Tecnología.</p>
        <p class="animar2" style="color:#818181;padding-left:15px; border-left: dashed 3px #ff5722; text-align:left; font-size: 24px">Personal de instituciones públicas y privadas vinculadas a la Educación.</p>
        <p class="animar3" style="color:#818181;padding-left:15px; border-left: dashed 3px #ff5722; text-align:left; font-size: 24px">Público en general.</p>
        <br>
        <br>
        <br>
...
while ($ResultadoC=mysqli_fetch_assoc($sql)) {
  ...
  if ($Nombre!="") {
  echo'
    <hr style="width: 10%; background: #ff5722" class="center-block">
    <div class="col-xs-12 col-sm-4">';
        echo "
        <div class='row'>
          <div class='col-xs-12 col-sm-12'>
            <img src='".$ResultadoC['Fotografia']."' class='img-responsive'>
          </div>";
        echo '
          <div class="col-xs-12 col-sm-12">
            <h4>Autor</h4>
            ...
            $Query3 = $conex->query("SELECT Ponencia.Categoria, Ponencia.IdPonencia, Ponencia.Titulo, Ponente.Nombres, Ponente.Apellidos, Ponente.Fotografia, Paises.name_pais, Programacion.Fecha, Programacion.Hora FROM Ponencia, Paises, Ponente, Programacion WHERE Programacion.IdPonencia='$IdPonencia' AND Ponencia.IdPonencia='$IdPonencia' AND Ponencia.Estado=1 AND Ponente.IdPonencia='$IdPonencia' AND Paises.id=Ponente.Pais AND Ponencia.Tipo=0");
              ...
              <div style="margin-top: 1%" class="col-sm-3 animar4">
                <div class="card">
                  ...
                  <hr style="margin-left:15px;width: 30%; background-color: #ff5722;" align="left">
...
<div class="container" style="margin-top:3%; height:500px;" id="Ponencias">
  <h3 style="color:#818181;font-size: 44px;text-align: center;">Todas las ponencias</h3>
          <hr style="width: 10%; background: #ff5722; color: #ff5722" class="center-block">
          <p>La agenda ha sido organizada, si desea saber quienes son los ponentes y autores de las ponencias puede dirigirse al menú categorías y seleccionar una de ellas.</p>
  <div class="row well animar2" style="z-index: 1000">
    <div class="col-sm-2" style="border-right: dashed 3px #ff5722;">
      <p>';
            ...
            <div style="position:relative" class="row" name="Repetir">
              ...
              <div class="col-xs-12 col-sm-9">
                <div class="papers Ubicacion">
                  ...
                  <span style="color:#ff5722;font-size:14px; float:right; padding-right:15px;">'.$FechaP.'/'.date("g:i a",strtotime($ResultadoP['Hora'])).' 
                  </span>
...
<div class="triangulo-equilatero-bottom-left animar2">
  <div class="row">
      <div class="col-sm-12" style="color: #fff;">
        <h2>¿Le interesa participar como ponente?</h2>
        <p>
