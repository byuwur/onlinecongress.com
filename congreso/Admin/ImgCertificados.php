...
include("Head.php");
$Consul = $conex->query("SELECT Id_Congreso FROM certificados WHERE Id_Congreso='$Id_Congreso'");
    ...
    <div class="well">
      ...
      <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
           <div class="alert alert-danger" role="alert">El formato de la imagen debe de ser .jpg o .png, su peso no debe superar 1 Mb y sus medidas deben ser de 1281 píxeles de ancho y 1738 píxeles de largo.</div>
        </div>
      </div>
    </div>
  </div>
