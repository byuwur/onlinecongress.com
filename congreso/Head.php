...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-133452079-1"></script>
<script>
  ...
  <meta name="author" content="Weapp.com.co">

  
  <meta charset="utf-8">
  <link href="Img_Web/logo.ico" rel="shortcut icon" type="image/x-icon" />
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <!-- Mobile support -->
  <meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <link rel="stylesheet" href="https://smaxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
...
.snip1543.hover figcaption:after {
  ...
  .triangulo-equilatero-bottom-left {
    ...
    border-left: 300px solid #11c3f0d9;
    border-bottom: 301px solid #11c3f0d9;
    z-index: 800;
    position: absolute;
   }
 </style>
